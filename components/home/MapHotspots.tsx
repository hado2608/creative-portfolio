...
// Brooklyn: left position, original render size 242×219, tilted
const BK_X = 91, BK_Y = 203, BK_W = 242, BK_H = 219
const BK_PIN_CX = BK_X + BK_W / 2
const BK_PIN_CY = BK_Y + BK_H / 2
const LEFT_ROT = -8

// Vietnam: right position, original render size 318×465, no tilt
const VN_X = 1082, VN_Y = 347, VN_W = 318, VN_H = 465

// Pin positions: centered on map, tip 4px above visual top of each shape in SVG coords
const VN_LABEL = { x: 1191, y: 318 }
const BK_LABEL = { x: 145, y: 181 }
  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 5 }}>
        <svg {...svgProps}>
          {/* Brooklyn — left position, original size, tilted */}
          <g
            transform={`rotate(${LEFT_ROT} ${BK_PIN_CX} ${BK_PIN_CY})`}
          ...
          {/* Vietnam — right position, original size, no tilt */}
          <g
