  ...
  return (
    <article style={{ background: 'var(--color-warm-bg)', color: 'var(--color-warm-body)', minHeight: '100vh' }}>
      ...
      <header style={{ ...CENTERED, paddingTop: 80 }}>
        ...
        <div
          id="hero-shot"
          style={{ borderRadius: 8, overflow: 'hidden', marginBottom: 40 }}
        >
          <img
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, paddingBottom: 56, borderBottom: '1px solid var(--color-warm-border)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 28, justifyContent: 'flex-end' }}>
            <div>
              ...
              <p style={{ fontFamily: "'Neue Montreal', sans-serif", fontSize: 18, letterSpacing: '0.02em', lineHeight: 1.75, color: 'var(--color-warm-body)' }}>4 weeks (Apr to May 2026)</p>
            </div>
            <div>
              ...
              <p style={{ fontFamily: "'Neue Montreal', sans-serif", fontSize: 18, letterSpacing: '0.02em', lineHeight: 1.75, color: 'var(--color-warm-body)' }}>Solo UI/UX Designer (Contract)</p>
            </div>
            <div>
      ...
      <div className="cs-body" style={{ ...CENTERED, marginTop: 80 }}>
        ...
        <div style={{ paddingBottom: 160, minWidth: 0 }}>
          ...
          <section id="overview" style={{ marginBottom: 128 }}>
            ...
            <p style={{ lineHeight: 1.75, fontSize: 18, letterSpacing: '0.02em', marginTop: 20 }}>
          ...
          <section id="initial-problem-discovery" style={{ marginBottom: 128 }}>
            ...
            <SubSection title="3.1 Swipe onboarding: how do you teach the gesture without a tutorial wall?">
              ...
              <p style={{ lineHeight: 1.75, fontSize: 18, letterSpacing: '0.02em', marginTop: 16 }}>
